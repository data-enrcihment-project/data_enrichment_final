...
public class GolfoutfitsSie extends Thread {
	...
	public void run() {
		...
		String Statement = "SELECT shop_item.description, shop_item.item_no FROM shop_item INNER JOIN shop_item_has_category "
				...
				+ "WHERE shop_item_has_category.category_line_no = 5500 ";
		String File = "Golfoutfits_sie.csv";
		try {
		...
		try {
			entry = Golflaedchen.getProducts("https://www.golflaedchen.de/Golfbekleidung-fuer-Damen/?p=1");

			entry.addAll(Golflaedchen.getProducts("https://www.golflaedchen.de/Golfbekleidung-fuer-Damen/?p=2"));

			entry.addAll(Golflaedchen.getProducts("https://www.golflaedchen.de/Golfbekleidung-fuer-Damen/?p=3"));
			
			entry.addAll(BestPreisGolf.getProducts("https://www.best-preis-golf.de/golfbekleidung/damenbekleidung/"));
			
			entry.addAll(BestPreisGolf.getProducts("https://www.best-preis-golf.de/golfbekleidung/damenbekleidung/?p=2"));

			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Damenbekleidung/"));
			
			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Damenbekleidung/8/"));
