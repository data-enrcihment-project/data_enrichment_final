...
public class Golfball extends Thread {
	...
	public void run() {
		...
		String Statement = "SELECT shop_item.description, shop_item.item_no FROM shop_item INNER JOIN shop_item_has_category "
				...
				+ "WHERE shop_item_has_category.category_line_no = 32500 ";
		String File = "Golfball.csv";
		try {
		...
		try {
			entry = Golflaedchen.getProducts("https://www.golflaedchen.de/Golfbaelle/?p=1");

			entry.addAll(Golflaedchen.getProducts("https://www.golflaedchen.de/Golfbaelle/?p=2"));
			
			entry.addAll(BestPreisGolf.getProducts("https://www.best-preis-golf.de/golf-baelle/?p=1"));

			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Baelle/Baelle/"));
			
			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Baelle/Baelle/2/"));
			
			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Baelle/Baelle/5/"));
