...
public class GolfschuheHerren extends Thread {
	@Override
	public void run() {
		...
		String Statement = "SELECT shop_item.description, shop_item.item_no FROM shop_item INNER JOIN shop_item_has_category "
				...
				+ "WHERE shop_item_has_category.category_line_no = 44921 ";
		String File = "Golfschuhe_herren.csv";
		try {
		...
		try {
			entry = Golflaedchen.getProducts("https://www.golflaedchen.de/Herren-Golfschuhe/?p=1");

			entry.addAll(Golflaedchen.getProducts("https://www.golflaedchen.de/Herren-Golfschuhe/?p=2"));

			entry.addAll(BestPreisGolf.getProducts("https://www.best-preis-golf.de/golfschuhe/herren-golfschuhe/?p=1"));

			entry.addAll(BestPreisGolf.getProducts("https://www.best-preis-golf.de/golfschuhe/herren-golfschuhe/?p=2"));
			
			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Herrenbekleidung/Schuhe/"));
