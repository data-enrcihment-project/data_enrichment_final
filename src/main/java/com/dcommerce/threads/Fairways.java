...
public class Fairways extends Thread {
	...
	public void run() {
		...
		try {
			entry = Golflaedchen.getProducts("https://www.golflaedchen.de/Golfschlaeger-Fairwayholz/?p=1");

			entry.addAll(Golflaedchen.getProducts("https://www.golflaedchen.de/Golfschlaeger-Fairwayholz/?p=2"));

			entry.addAll(BestPreisGolf.getProducts("https://www.best-preis-golf.de/golfschlaeger/fairwayhoelzer/?p=1"));

			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Golfschlaeger/Fairways/"));
			
			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Golfschlaeger/Fairways/2/"));
			
			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Golfschlaeger/Fairways/3/"));
			
			entry.addAll(GolfUndGuenstig.getProducts("https://www.golfundguenstig.de/Golfschlaeger/Fairways/4/"));
