...
<%@ page import="com.dcommerce.database.*"%>
...
<body>
	<div id="wrapper">
		...
		<!-- /.navbar-header --> <!-- /.navbar-top-links --> <nav
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						<!-- href="MD_test_API_workaround.html" --> <a><i href="#"
							class="fa fa-dashboard fa-fw"></i> API Work-around <small>(Amazon
								and eBay)</small><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">

							<li><a href="index.jsp">API Dashboard</a></li>
							<li><a href="SimilarItemsModule.jsp">Similar Items For
									Ebay and Amazon</a></li>

						</ul>
					</li>

					<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>
							Pricing Module<span class="fa arrow"></span></a>


						<ul class="nav nav-second-level">

							<li><a href="price_module.jsp">Pricing Dashboard</a></li>
							<li><a href="PricingChart.jsp">Pricing Chart</a></li>
						</ul> <!-- /.nav-second-level --></li>
					<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>
							Review Module<span class="fa arrow"></span></a>


						<ul class="nav nav-second-level">
							<li><a href="ReviewModule.jsp">Review Dashboard</a></li>


						</ul></li>
					<li><a href="#"><i class="fa fa-table fa-fw"></i>
							Performed jobs<span class="fa arrow"></span></a>

						<ul class="nav nav-second-level">

							<li><a href="Performed_Jobs.jsp">Enrichment Performed</a></li>
							<li><a>All</a></li>
							<li><a>Today</a></li>
							<li><a>This week</a></li>
		...
		<!-- /.navbar-static-side --> </nav> <!-- /.navbar-static-side --> </nav>
								...
								<table class="table">
									...
									<tbody>
										<%
											...
											ArrayList<SimilarProducts> simList = (ArrayList<SimilarProducts>)request.getAttribute("list");
											
											for(SimilarProducts simProduct : simList) {
                                     			String similarProduct = simProduct.getDescription();
                                     			String similarBase = simProduct.getBase_price();
                                     			String similarDiscount = simProduct.getDiscount_price();
                                     			String shop_name = simProduct.getShop_name();
                                     			String concatenated = similarProduct + " - " + shop_name;
                                     			
                                     			map = new HashMap<Object, Object>(); 
												map.put("label", concatenated);
